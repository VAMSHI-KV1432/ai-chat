...
import type { ConversationId as _ConversationId, ConversationPublic as _ConversationPublic, Message as _Message, Role as _Role, SessionKey as _SessionKey, Timestamp as _Timestamp } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async createConversation(arg0: SessionKey, arg1: string): Promise<ConversationId> {
    ...
    async deleteConversation(arg0: SessionKey, arg1: ConversationId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getConversation(arg0: SessionKey, arg1: ConversationId): Promise<ConversationPublic | null> {
        if (this.processError) {
            try {
    ...
    async listConversations(arg0: SessionKey): Promise<Array<ConversationSummary>> {
        if (this.processError) {
            try {
    ...
    async renameConversation(arg0: SessionKey, arg1: ConversationId, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: SessionKey, arg1: ConversationId, arg2: string): Promise<string> {
        if (this.processError) {
            try {
...
function from_candid_ConversationPublic_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ConversationPublic): ConversationPublic {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ConversationPublic]): ConversationPublic | null {
    return value.length === 0 ? null : from_candid_ConversationPublic_n2(_uploadFile, _downloadFile, value[0]);
}
